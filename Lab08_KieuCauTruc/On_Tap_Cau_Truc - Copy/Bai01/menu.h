...
void XuLyMenu(int menu, MangNV a, int& n)
{
	...
	{
	case 1:
		cout << endl << "Nhap danh sach nhan vien moi";
	...
	case 3:
		cout << endl << "Them mot nhan vien" << endl;
		ThemMotNV(a, n);
		break;

	case 4:
		cout << endl << "Tim nhan vien theo ma so" << endl;
		cout << "Nhap ma so nhan vien: "; cin >> maSo;
		ketQua = TimTheoMaSo(a, n, maSo);
		if (ketQua == -1)
	...
	case 5:
		...
		ketQua = TimTheoMaSo(a, n, maSo);
		if (ketQua == -1)
			cout << endl << "Khong tim thay nhan vien co ma so " << maSo << ", vui long nhap lai !";
		else
		{
			CapNhatNV(a[ketQua]);
	...
	case 6:
		cout << endl << "Tim nhan vien theo nam sinh";
		cout << endl << "Nhap nam sinh: "; cin >> namSinh;
		ketQua = TimNVTheoNamSinh(a, n, namSinh);
		if (ketQua == 0)
			cout << endl << "Khong tim thay nhan vien nao sinh nam " << namSinh;
		else cout << endl << "Co tat ca " << ketQua << " nhan vien sinh nam " << namSinh;
		break;
